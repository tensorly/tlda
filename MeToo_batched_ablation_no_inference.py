...
TLDA_FILEPATH       = '/Users/skangaslahti/tlda/data/Meena_testing/tlda_metoo_comparison' + str(MONTHS) + '.obj' # store the TLDA object
WEIGHTS_FILEPATH    = '/Users/skangaslahti/tlda/data/Meena_testing/weights_tlda'+str(MONTHS)+'.txt'
...
TOP_WORDS_FILEPATH                = '/Users/skangaslahti/tlda/data/top_words'+str(MONTHS)+'.csv' # save the top words per topic
...
alpha_0 = 0.01
batch_size_pca  = 300000  # this will handle 2000 words + 100 topics ad infinite number of documents 
#batch_size_pca  = 5000 # for whitening
batch_size_grad = 250000 # 1% of data size - see what coherence looks like - can also try increasing  #divide data by 1,000 ## 800 = -3322.32 (6000 seecond) 4000=-3320 (1800 seconds) 8000=-3325 (1180 seconds)  Lower this to 1% of TOTAL data size
n_iter_train    = 1000
n_iter_test     = 1
# 0.0005

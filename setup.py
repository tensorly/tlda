...
def version(root_path):
    ...
    """
    version_path = root_path.joinpath('tlda', '__init__.py')
...
config = {
    ...
    'description': 'Scalable Tensor LDA with TensorLy.',
    ...
    'download_url': 'https://github.com/tensorly/tlda/tarball/' + VERSION,

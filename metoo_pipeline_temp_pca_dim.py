...
def fit_topics(num_tops, curr_dir, first_run = False, alpha_0 = 0.01, learning_rate = 0.0004, theta_param = 5.005, ortho_loss_param = 1000, initialize_first_docs = False, n_eigenvec = None): #, online=True, num_init=3):
...
#                                 max_df = 10000, # limit this to 10,000 ## 500000 for 8M
    ...
    batch_size_grad = 8000 # 1% of data size - see what coherence looks like - can also try increasing  #divide data by 1,000 ## 800 = -3322.32 (6000 seecond) 4000=-3320 (1800 seconds) 8000=-3325 (1180 seconds)  Lower this to 1% of TOTAL data size
    smoothing   = 1e-7
    n_iter_train = 200
    n_iter_test = 10

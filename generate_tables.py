...
def main():
    ...
    acc_centered = []
    acc_sklearn = []
    vocab_arr = [500, 1000]#, 500, 1000, 1500, 2000] # , 1000] # , 1500] # , 2000, 2500]
    theta_arr = [5]#[1, 5, 10] #1]#, 5, 10] #, 25] # , 50]
    # theta_arr = [1]
            ...
            for lr in lr_arr:
                for theta in theta_arr:
                    ...
                    #     tot_sklearn[vocab] = res_sklearn
                        ...
                        tot_uncentered[vocab] = [(x, y + res_uncentered[i][1]) for i, (x, y) in enumerate(tot_uncentered)]
